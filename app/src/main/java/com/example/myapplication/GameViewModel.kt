...
class GameViewModel : ViewModel() {
    ...
    private val themeWords = mapOf(
        ...
        MusicTheme.CHILE to listOf(
            // Comida chilena
            "Completo", "Empanada", "Pastel de Choclo", "Cazuela", "Sopaipilla",
            "Charquicán", "Humita", "Porotos Granados", "Curanto", "Pebre",
            "Mote con Huesillo", "Alfajor", "Manjar", "Calzones Rotos", "Churrasco",
            "Choripán", "Palta Reina", "Machas a la Parmesana", "Reineta Frita", "Merluza",
            // Bebidas
            "Pisco Sour", "Terremoto", "Chicha", "Cola de Mono", "Navegado",
            "Mote con Huesillo", "Bilz", "Pap", "Kem Xtreme", "Cachantún",
            // Lugares
            "Valparaíso", "Viña del Mar", "Isla de Pascua", "Torres del Paine", "San Pedro de Atacama",
            "Puerto Varas", "Pucón", "La Serena", "Arica", "Punta Arenas",
            "Cerro San Cristóbal", "Barrio Bellavista", "Plaza de Armas", "Costanera Center", "Cerro Santa Lucía",
            // Personajes históricos
            "Arturo Prat", "Bernardo O'Higgins", "José Miguel Carrera", "Manuel Rodriguez", "Diego Portales",
            "Violeta Parra", "Pablo Neruda", "Gabriela Mistral", "Nicanor Parra", "Isabel Allende",
            // Deportistas
            "Arturo Vidal", "Alexis Sánchez", "Gary Medel", "Claudio Bravo", "Iván Zamorano",
            "Marcelo Salas", "Nicolás Massú", "Fernando González", "Tomás González", "Christiane Endler",
            // Animales y naturaleza
            "Huemul", "Cóndor", "Pudú", "Pingüino de Humboldt", "Lobo Marino",
            "Araucaria", "Copihue", "Palma Chilena", "Quillay", "Alerce",
            // Cultura y tradiciones
            "Cueca", "Rodeo", "Fonda", "Ramada", "Volantín",
            "Roto Chileno", "Huaso", "Pinochet", "Allende", "Carabineros",
            // Expresiones chilenas
            "Cachai", "Weon", "Pololo", "Carrete", "Copete",
            "Palta", "Fome", "Bacán", "Cuico", "Flaite",
            // Música chilena
            "Los Prisioneros", "La Ley", "Los Bunkers", "Noche", "Chancho en Piedra",
            "Mon Laferte", "Gepe", "Javiera Mena", "Francisca Valenzuela", "Lucybell",
            // TV y medios
            "31 Minutos", "Tulio Triviño", "Stefan Kramer", "Don Francisco", "Canal 13",
            "TVN", "Mega", "CHV", "El Mercurio", "La Cuarta",
            // Empresas y marcas
            "Falabella", "Ripley", "Copec", "Entel", "Movistar",
            "BancoEstado", "Santa Isabel", "Unimarc", "Jumbo", "Líder"
        )
    )
    ...
    private val wordDescriptions = mapOf(
        ...
        // Chile - Comida
        "Completo" to "Hot dog con palta, tomate y mayonesa",
        "Empanada" to "Masa rellena de pino, queso o mariscos",
        "Pastel de Choclo" to "Pastel de maíz con carne y pollo",
        "Cazuela" to "Sopa con carne, papa, zapallo y choclo",
        "Sopaipilla" to "Masa frita de zapallo, se come con pebre",
        "Charquicán" to "Guiso de carne molida con papas y zapallo",
        "Humita" to "Choclo molido envuelto en hojas",
        "Porotos Granados" to "Porotos con choclo y zapallo",
        "Curanto" to "Plato de Chiloé con mariscos y carne",
        "Pebre" to "Salsa de tomate, cebolla y cilantro",
        "Mote con Huesillo" to "Bebida dulce de trigo y durazno",
        "Alfajor" to "Galleta con manjar",
        "Manjar" to "Dulce de leche chileno",
        "Calzones Rotos" to "Masa frita con azúcar flor",
        "Churrasco" to "Carne en pan tipo marraqueta",
        "Choripán" to "Chorizo en pan con pebre",
        "Palta Reina" to "Palta rellena con pollo mayonesa",
        "Machas a la Parmesana" to "Mariscos gratinados",
        "Reineta Frita" to "Pescado frito típico chileno",
        "Merluza" to "Pescado blanco muy consumido",
        // Bebidas
        "Pisco Sour" to "Cóctel de pisco, limón y azúcar",
        "Terremoto" to "Vino pipeño con helado de piña",
        "Chicha" to "Bebida fermentada de uva",
        "Cola de Mono" to "Bebida con aguardiente, leche y café",
        "Navegado" to "Vino caliente con especias navideñas",
        "Bilz" to "Bebida gaseosa roja chilena",
        "Pap" to "Bebida gaseosa amarilla chilena",
        "Kem Xtreme" to "Bebida energética chilena",
        "Cachantún" to "Marca de agua mineral chilena",
        // Lugares
        "Valparaíso" to "Puerto con cerros y ascensores",
        "Viña del Mar" to "Ciudad jardín, festival de la canción",
        "Isla de Pascua" to "Isla con moais en el Pacífico",
        "Torres del Paine" to "Parque nacional en la Patagonia",
        "San Pedro de Atacama" to "Pueblo en el desierto más árido",
        "Puerto Varas" to "Ciudad del sur con volcán Osorno",
        "Pucón" to "Ciudad turística con volcán Villarrica",
        "La Serena" to "Ciudad del norte, playas",
        "Arica" to "Ciudad más al norte, morro",
        "Punta Arenas" to "Ciudad más austral de Chile",
        "Cerro San Cristóbal" to "Cerro de Santiago con Virgen",
        "Barrio Bellavista" to "Barrio bohemio de Santiago",
        "Plaza de Armas" to "Plaza central de Santiago",
        "Costanera Center" to "Edificio más alto de Sudamérica",
        "Cerro Santa Lucía" to "Cerro histórico en Santiago",
        // Personajes históricos
        "Arturo Prat" to "Héroe naval de Iquique",
        "Bernardo O'Higgins" to "Padre de la patria chilena",
        "José Miguel Carrera" to "Prócer de la independencia",
        "Manuel Rodriguez" to "Guerrillero de la independencia",
        "Diego Portales" to "Ministro organizador de la república",
        "Violeta Parra" to "Folclorista, Gracias a la Vida",
        "Pablo Neruda" to "Poeta, Premio Nobel de Literatura",
        "Gabriela Mistral" to "Primera latinoamericana Nobel Literatura",
        "Nicanor Parra" to "Antipoeta chileno",
        "Isabel Allende" to "Escritora de La Casa de los Espíritus",
        // Deportistas
        "Arturo Vidal" to "Rey Arturo, mediocampista",
        "Alexis Sánchez" to "Niño Maravilla, delantero histórico",
        "Gary Medel" to "Pitbull, defensa aguerrido",
        "Claudio Bravo" to "Arquero histórico de Chile",
        "Iván Zamorano" to "Bam Bam, goleador histórico",
        "Marcelo Salas" to "Matador, dupla con Zamorano",
        "Nicolás Massú" to "Tenista, medallas olímpicas",
        "Fernando González" to "Bombardero de La Reina, tenista",
        "Tomás González" to "Gimnasta olímpico chileno",
        "Christiane Endler" to "Tiane, arquera la Roja femenina",
        // Animales y naturaleza
        "Huemul" to "Ciervo en el escudo de Chile",
        "Cóndor" to "Ave rapaz en el escudo de Chile",
        "Pudú" to "Ciervo más pequeño del mundo",
        "Pingüino de Humboldt" to "Pingüino de la costa chilena",
        "Lobo Marino" to "Mamífero marino de costas chilenas",
        "Araucaria" to "Árbol milenario del sur de Chile",
        "Copihue" to "Flor nacional de Chile, roja",
        "Palma Chilena" to "Palmera endémica de Chile central",
        "Quillay" to "Árbol chileno con propiedades",
        "Alerce" to "Árbol milenario de la Patagonia",
        // Cultura y tradiciones
        "Cueca" to "Baile nacional de Chile",
        "Rodeo" to "Deporte nacional ecuestre",
        "Fonda" to "Lugar de celebración en Fiestas Patrias",
        "Ramada" to "Estructura de fonda dieciochera",
        "Volantín" to "Cometa que se vuela en septiembre",
        "Roto Chileno" to "Arquetipo del pueblo chileno",
        "Huaso" to "Campesino chileno a caballo",
        "Pinochet" to "Dictador militar 1973-1990",
        "Allende" to "Presidente socialista derrocado",
        "Carabineros" to "Policía uniformada de Chile",
        // Expresiones chilenas
        "Cachai" to "¿Entiendes? en chileno",
        "Weon" to "Compadre, amigo en chileno",
        "Pololo" to "Novio en chileno",
        "Carrete" to "Fiesta en chileno",
        "Copete" to "Alcohol, trago en chileno",
        "Palta" to "Aguacate, vergüenza ajena",
        "Fome" to "Aburrido en chileno",
        "Bacán" to "Genial, bueno en chileno",
        "Cuico" to "Persona de clase alta",
        "Flaite" to "Persona de barrio, vulgar",
        // Música chilena
        ...
        "Javiera Mena" to "Cantante chilena de electropop",
        "Francisca Valenzuela" to "Cantautora chilena de pop",
        "Lucybell" to "Banda chilena de rock alternativo",
        // TV y medios
        "31 Minutos" to "Programa de títeres chileno",
        "Tulio Triviño" to "Presentador de 31 Minutos",
        "Stefan Kramer" to "Imitador y humorista chileno",
        "Don Francisco" to "Animador de Sábado Gigante",
        "Canal 13" to "Canal de TV católico chileno",
        "TVN" to "Televisión Nacional de Chile",
        "Mega" to "Canal de televisión chileno",
        "CHV" to "Chilevisión, canal de TV",
        "El Mercurio" to "Diario más antiguo de Chile",
        "La Cuarta" to "Diario popular chileno",
        // Empresas y marcas
        "Falabella" to "Retail chileno, tienda por departamento",
        "Ripley" to "Tienda por departamento chilena",
        "Copec" to "Empresa de combustibles chilena",
        "Entel" to "Empresa de telecomunicaciones",
        "Movistar" to "Empresa de telefonía en Chile",
        "BancoEstado" to "Banco público de Chile",
        "Santa Isabel" to "Supermercado chileno",
        "Unimarc" to "Cadena de supermercados chilena",
        "Jumbo" to "Hipermercado chileno",
        "Líder" to "Supermercado de Walmart Chile"
    )
    ...
    private val wordClues = mapOf(
        ...
        // Chile - Comida
        "Completo" to "Hot dog chileno con varios ingredientes",
        "Empanada" to "Masa horneada o frita con relleno",
        "Pastel de Choclo" to "Maíz dulce gratinado",
        "Cazuela" to "Sopa tradicional con verduras",
        "Sopaipilla" to "Masa frita de calabaza",
        "Charquicán" to "Guiso de papas y carne",
        "Humita" to "Maíz molido envuelto",
        "Porotos Granados" to "Legumbres con maíz",
        "Curanto" to "Plato de Chiloé con mariscos",
        "Pebre" to "Salsa picante chilena",
        "Mote con Huesillo" to "Bebida dulce típica",
        "Alfajor" to "Galleta dulce con relleno",
        "Manjar" to "Dulce de leche",
        "Calzones Rotos" to "Dulce frito con azúcar",
        "Churrasco" to "Carne en pan",
        "Choripán" to "Chorizo en marraqueta",
        "Palta Reina" to "Aguacate relleno con pollo",
        "Machas a la Parmesana" to "Moluscos gratinados",
        "Reineta Frita" to "Pescado frito",
        "Merluza" to "Pescado blanco común",
        // Bebidas
        "Pisco Sour" to "Cóctel con pisco y limón",
        "Terremoto" to "Bebida con helado de piña",
        "Chicha" to "Bebida fermentada",
        "Cola de Mono" to "Bebida con leche y licor",
        "Navegado" to "Vino caliente especiado",
        "Bilz" to "Gaseosa roja nacional",
        "Pap" to "Gaseosa amarilla nacional",
        "Kem Xtreme" to "Energética chilena",
        "Cachantún" to "Agua mineral embotellada",
        // Lugares
        "Valparaíso" to "Puerto con cerros coloridos",
        "Viña del Mar" to "Ciudad jardín costera",
        "Isla de Pascua" to "Rapa Nui, moais",
        "Torres del Paine" to "Parque en Patagonia",
        "San Pedro de Atacama" to "Pueblo en el desierto",
        "Puerto Varas" to "Ciudad de los lagos",
        "Pucón" to "Turismo aventura, volcán",
        "La Serena" to "Ciudad del norte",
        "Arica" to "Primavera eterna, norte",
        "Punta Arenas" to "Extremo sur, pingüinos",
        "Cerro San Cristóbal" to "Mirador con Virgen",
        "Barrio Bellavista" to "Vida nocturna bohemia",
        "Plaza de Armas" to "Centro histórico Santiago",
        "Costanera Center" to "Rascacielos más alto",
        "Cerro Santa Lucía" to "Parque urbano histórico",
        // Personajes históricos
        "Arturo Prat" to "Combate naval, héroe",
        "Bernardo O'Higgins" to "Libertador de Chile",
        "José Miguel Carrera" to "Patricio independentista",
        "Manuel Rodriguez" to "Guerrillero patriota",
        "Diego Portales" to "Organizador república",
        "Violeta Parra" to "Folclor, Gracias a la Vida",
        "Pablo Neruda" to "Poeta, 20 poemas",
        "Gabriela Mistral" to "Poetisa, educadora",
        "Nicanor Parra" to "Antipoemas",
        "Isabel Allende" to "Escritora best-seller",
        // Deportistas
        "Arturo Vidal" to "Rey, mediocampista",
        "Alexis Sánchez" to "Niño Maravilla",
        "Gary Medel" to "Pitbull central",
        "Claudio Bravo" to "Arquero capitán",
        "Iván Zamorano" to "Bam Bam, 9",
        "Marcelo Salas" to "Matador goleador",
        "Nicolás Massú" to "Oro olímpico tenis",
        "Fernando González" to "Bombardero zurdo",
        "Tomás González" to "Gimnasta olímpico",
        "Christiane Endler" to "Arquera mundial",
        // Animales y naturaleza
        "Huemul" to "Ciervo del escudo",
        "Cóndor" to "Ave del escudo",
        "Pudú" to "Ciervo enano",
        "Pingüino de Humboldt" to "Ave marina costera",
        "Lobo Marino" to "Mamífero de playa",
        "Araucaria" to "Árbol pehuén milenario",
        "Copihue" to "Flor nacional roja",
        "Palma Chilena" to "Palmera nativa",
        "Quillay" to "Árbol medicinal",
        "Alerce" to "Árbol ancestral sur",
        // Cultura y tradiciones
        "Cueca" to "Baile de pañuelo",
        "Rodeo" to "Deporte huaso, corraleja",
        "Fonda" to "Celebración dieciocho",
        "Ramada" to "Techo de fonda",
        "Volantín" to "Cometa de papel",
        "Roto Chileno" to "Pueblo trabajador",
        "Huaso" to "Campesino a caballo",
        "Pinochet" to "Dictador golpista",
        "Allende" to "Presidente UP",
        "Carabineros" to "Policía verde",
        // Expresiones chilenas
        "Cachai" to "Entiendes, cachar",
        "Weon" to "Huevón, amigo",
        "Pololo" to "Novio, pareja",
        "Carrete" to "Fiesta, celebración",
        "Copete" to "Trago, alcohol",
        "Palta" to "Vergüenza, aguacate",
        "Fome" to "Aburrido, malo",
        "Bacán" to "Genial, excelente",
        "Cuico" to "Persona rica",
        "Flaite" to "Ordinario, barrio",
        // Música chilena
        "Los Prisioneros" to "El baile de los que sobran",
        "La Ley" to "El duelo, rock chileno",
        "Los Bunkers" to "Llueve sobre la ciudad",
        "Noche" to "Vivo, banda nacional",
        "Chancho en Piedra" to "Socio, funk chileno",
        "Mon Laferte" to "Tu falta de querer",
        "Gepe" to "Hablar de ti, indie",
        "Javiera Mena" to "Electropop chileno",
        "Francisca Valenzuela" to "Peces, cantautora",
        "Lucybell" to "De sudor y ternura",
        // TV y medios
        "31 Minutos" to "Títeres noticiosos",
        "Tulio Triviño" to "Periodista de títeres",
        "Stefan Kramer" to "Imitador famosos",
        "Don Francisco" to "Sábado Gigante",
        "Canal 13" to "TV UC",
        "TVN" to "Televisión estatal",
        "Mega" to "Canal privado",
        "CHV" to "Canal Chilevisión",
        "El Mercurio" to "Diario centenario",
        "La Cuarta" to "Diario rojo popular",
        // Empresas y marcas
        "Falabella" to "Retail, tienda grande",
        "Ripley" to "Retail, competidor Falabella",
        "Copec" to "Bencina, combustible",
        "Entel" to "Telefonía móvil",
        "Movistar" to "Celulares, telefonía",
        "BancoEstado" to "Banco público",
        "Santa Isabel" to "Supermercado barrio",
        "Unimarc" to "Supermercado SMU",
        "Jumbo" to "Hipermercado Cencosud",
        "Líder" to "Supermercado económico"
    )
    ...
    private val themeClues = mapOf(
        ...
        MusicTheme.CHILE to "Relacionado con cultura, tradiciones o lugares típicos de Chile"
    )
